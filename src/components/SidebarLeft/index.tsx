        ...
        <>
            ...
            >
                <nav className="space-y-4 p-4">
                    <Link to={'/'} className="flex items-center bg-white space-x-3 text-gray-900 hover:bg-gray-700 p-3 rounded-md">
                        <LuLayoutGrid /> <span>Dashboard</span>
                    </Link>
                    <Link to={'/modul'} className="flex items-center space-x-3 text-gray-300 hover:bg-gray-700 p-3 rounded-md">
                        <FaRegNewspaper /> <span>Modul</span>
                    </Link>
                    <Link to={'/peserta'} className="flex items-center space-x-3 text-gray-300 hover:bg-gray-700 p-3 rounded-md">
                        <LuUsers /> <span>Peserta</span>
                    </Link>
                    <Link to={'/group-chat'} className="flex items-center space-x-3 text-gray-300 hover:bg-gray-700 p-3 rounded-md">
                        <IoChatboxEllipsesOutline /> <span>Group  Chat</span>
                    </Link>
                    <Link to={'/pemateri'} className="flex items-center space-x-3 text-gray-300 hover:bg-gray-700 p-3 rounded-md">
                        <FaRegUser /> <span>Pemateri</span>
                    </Link>
                    <hr />
                    <Link to={'/settings'} className="flex items-center space-x-3 text-gray-300 hover:bg-gray-700 p-3 rounded-md">
                        <IoSettingsOutline /> <span>Settings</span>
                    </Link>
                    <Link to={'/kalender'} className="flex items-center space-x-3 text-gray-300 hover:bg-gray-700 p-3 rounded-md">
